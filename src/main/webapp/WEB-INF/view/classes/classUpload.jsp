...
function addContent() {
    ...
    newFile.setAttribute("name", "contentFile")
    ...
    inputDiv.append(addLabel1, newTitle, addLabel2, newFile, removeButton)
		...
		<div class="container">
			<form action="<%=request.getContextPath()%>/classes/classUploadPro" enctype="multipart/form-data" method="post" name="inputform">
	           ...
	           <div class="form-group">
					...
					컨텐츠 파일을 입력하세요.<input type="file" name="contentFile" class="form-control" required="required">
